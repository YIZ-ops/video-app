...
Page({
  ...
  onLoad: function (params) {
    ...
    // 获取所有视频列表分页信息
    that.getAllVideoList(currentPage, loginUserId);
  },
  // 获取所有视频列表分页信息
  getAllVideoList: function (currentPage, loginUserId) {
    var that = this;
    ...
    // 请求视频分页数据
    wx.request({
      url: `${serverUrl}ware/videos/showVideos?currentPage=${currentPage}&loginUserId=${loginUserId}`,
      method: 'POST',
  ...
  onPullDownRefresh: function () {
    ...
    // 请求第一页的数据
    this.getAllVideoList(1, loginUserId);
  },
  // 滑动到页面底部（上拉刷新）
  onReachBottom: function () {
    ...
    // 获取所有视频列表分页信息
    that.getAllVideoList(currentPage + 1, loginUserId);
  },
  // 展示视频详情信息
